...
const getExpensesByCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expensesSummaryRaw = yield prisma.expenseByCategory.findMany({
            where: {
                category: {
        ...
        const expenseByCategorySummary = expensesSummaryRaw.map((item) => (Object.assign(Object.assign({}, item), { amount: item.amount.toString() })));
